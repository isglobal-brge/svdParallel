...
```{r breast3, fig.width=9, fig.height=5.5, fig.cap="Plot of the variables (left) and individuals (right) of the breast data in the first two principal components.", out.width = "30%"}
par(mfrow=c(1,2))
plot(gpcaL)
