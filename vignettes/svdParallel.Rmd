...
```{r,echo=TRUE, fig.width=7, fig.height=4,fig.show='hold', fig.align='center', fig.cap="Plot of the variables (left) and individuals (right) using getPCA function."}
par(mfrow=c(1,2))
...
```{r,echo=TRUE, fig.width=7, fig.height=4,fig.show='hold',fig.align='center', fig.cap="Plot of the variables (left) and individuals (right) in the first and third components."}
par(mfrow=c(1,2))
...
```{r iris7, fig.show='hold',fig.align='center',fig.cap="Plot of the individuals of the iris dataset according to the species they belong."}
par(mfrow=c(1,1))
...
```{r breast1c, echo=FALSE, fig.cap="Flowchart of the Block method procedure."}
...
```{r breast3, fig.width=7, fig.height=4,fig.show='hold', fig.cap="Plot of the variables (left) and individuals (right) of the breast data in the first two principal components."}
par(mfrow=c(1,2))
plot(gpcaL)
...
```{r breast2b, fig.width=7, fig.height=4,fig.show='hold', fig.cap="Plot of the variables (left) and individuals (right) of the breast data using PCA function."}
